...
public class NovoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(senha!=null && senha.equals("1234")){
            RequestDispatcher despachante = request.getRequestDispatcher("/WEB-INF/oi.jsp");
            despachante.forward(request, response);
              
        }else 
        {
            RequestDispatcher despachante = request.getRequestDispatcher("/WEB-INF/AcessoPro.html");
            despachante.forward(request, response);
        }
    }
